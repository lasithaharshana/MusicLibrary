    ...
    <div style={backgroundImageStyle} className="container mx-auto flex justify-center items-center h-screen relative">
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 px-4" style={signupBoxStyle}>
        <form onSubmit={handleSubmit} className="mt-4">
          <h1 className="text-2xl font-bold text-center mb-4 text-white">Create Account</h1>
          <input
            type="text"
          ...
          <button type="submit" className="w-full bg-green-500 text-white p-2 rounded mt-4 hover:bg-green-600" style={{ width: "70%" }}>
            Sign Up
          </button>
          <Link to="/login">
            <button type="button" className="w-full bg-blue-500 text-white p-2 rounded mt-2 hover:bg-blue-600" style={{ width: "70%" }}>
              Sign In
            </button>
          </Link>
        </form>
